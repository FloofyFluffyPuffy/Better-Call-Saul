      ...
      <section className="px-4 w-full h-[90vh] border-b-3 pb-14 pt-36 sm:px-8 sm:pt-40" >
        <div className="mx-auto py-4  max-w-6xl text-center">
          ...
          <h1 className="relative font-display-xl text-[clamp(3.4rem,11vw,8rem)] uppercase leading-[0.82] text-[#89ACE7] [text-shadow:5px_5px_0_#000]">
           ...
           <img src="/assets/saulCoffee.png" alt="Saul Goodman holding a coffee" className="pointer-events-none absolute left-1/2 top-[34%] z-20 h-124 w-124 -translate-y-55 translate-x-30" />
