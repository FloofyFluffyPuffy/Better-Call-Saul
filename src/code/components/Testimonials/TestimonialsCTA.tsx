...
const TestimonialsCTA = () => {
  return (
        ...
        <div className="mx-auto max-w-4xl -rotate-1 border-[3px] border-black bg-[#fffdf3] px-5 py-9 text-center shadow-[7px_7px_0_#000] sm:px-10">
          ...
          <Link href="tel:+15551234567" className="mt-7 inline-flex rotate-1 items-center gap-2 border-[3px] border-black bg-[#e23d28] px-5 py-3 font-headline-lg text-2xl text-yellow-300 shadow-[4px_4px_0_#000] transition-transform hover:translate-x-1 hover:translate-y-1 hover:shadow-none">
            <img src="/assets/phone.svg" alt="" className="phone-icon-yellow h-6 w-6" />
            DIAL 505-503-4455
          </Link>
        </div>
      </section>
